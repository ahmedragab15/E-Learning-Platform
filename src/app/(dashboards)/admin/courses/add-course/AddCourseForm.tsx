            ...
            <CardHeader>
              <Tabs defaultValue="basic" className="w-full">
                  ...
                  <CardContent className="space-y-6 p-0">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                      <div className="space-y-2">
                        ...
                        <Input id="courseName" defaultValue="UI/UX Design For Beginner" />
                      </div>
                      <div className="space-y-2">
                      ...
                      <div className="space-y-2">
                        ...
                        <div className="flex">
                          ...
                          <Input id="coursePrice" defaultValue="299" className="rounded-l-none" />
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="space-y-2">
                      ...
                      <Select defaultValue="27-may-2021">
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                        ...
                        <div className="space-y-2">
                          ...
                          <div className="flex">
                            ...
                            <Input id="discountPrice" defaultValue="50" className="rounded-l-none" />
                          </div>
                        </div>
                      </div>
                ...
                <TabsContent value="translation">
                  <div className="text-center py-8 text-muted-foreground">Translation content will be here</div>
                </TabsContent>

                <TabsContent value="question">
                  <div className="text-center py-8 text-muted-foreground">Question content will be here</div>
                </TabsContent>
              </Tabs>
            </CardHeader>
          </Card>
